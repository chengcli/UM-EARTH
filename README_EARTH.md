...
For accessing the ECMWF Climate Data Store (CDS), read the instructions at `um_earth/ecmwf_api/README_ECMWF.md`.
...
- **Location**: `um_earth/ecmwf_api/`
- **Documentation**: See `um_earth/ecmwf_api/README_ECMWF.md`
