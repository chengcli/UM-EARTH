...
FORECAST_CYCLE=00
FORECAST_START_UTC=2026-07-29T00:00:00Z
FORECAST_END_SECONDS=172800
PREDICTION_DURATION=108000
RUN_DIR="$RUNS_DIR/pte1b-2026-07-29-hres00"
...
OUTPUT_DIR="$RUN_DIR/forecast_refined_hres_hourly_48h_2gpu"
...
SESSION_NAME=pte1b_20260729_00_hres_refined_48h_2gpu
SMOKE_PORT="${SMOKE_PORT:-29728}"
