...
FORECAST_CYCLE=06
FORECAST_START_UTC=2026-07-15T06:00:00Z
RUN_DIR="$RUNS_DIR/pte1b-2026-07-15-hres06"
...
OUTPUT_DIR="$RUN_DIR/forecast_refined_hres_hourly_78h_2gpu"
...
SESSION_NAME=pte1b_20260715_06_hres_refined_78h_2gpu
SMOKE_PORT="${SMOKE_PORT:-29714}"
...
FORECAST_LEADS=(0 6 12)
for lead in $(seq 18 78); do
  FORECAST_LEADS+=("$lead")
done
